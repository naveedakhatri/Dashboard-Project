...
app.layout = html.Div([
    ...
    #May include style for title
     html.Div([#TASK 2.2: Add two dropdown menus
         html.Label("Here you will Select the Report:"),
         dcc.Dropdown(
             ...
             style={'textAlign': 'center', 'padding':'3px','width': '80%', 'font-size': 20},
                    )
     ]),
...
def update_input_container(): #need input here
...
def update_output_container(input_year): #need 2 inputs here
